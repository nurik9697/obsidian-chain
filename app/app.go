...
import (
	...
	notarymodulekeeper "obsidian/x/notary/keeper"
    ...
    // Capability (необходим для прав доступа к портам IBC)
    capabilitytypes "github.com/cosmos/ibc-go/modules/capability/types"
    ibcexported "github.com/cosmos/ibc-go/v8/modules/core/exported"
    ibctransfertypes "github.com/cosmos/ibc-go/v8/modules/apps/transfer/types"

    // Interchain Accounts (ICA) - Обязательно для твоего App struct
...
type App struct {
	*runtime.App
	...
	NotaryKeeper notarymodulekeeper.Keeper
...
func New(
	...
	// build app
        ...
        // --- ФИНАЛЬНАЯ ИСПРАВЛЕННАЯ ИНИЦИАЛИЗАЦИЯ IBC ---
        ...
        app.IBCKeeper = ibckeeper.NewKeeper(
                ...
                app.UpgradeKeeper,
                app.ScopedIBCKeeper,
                ibcexported.ModuleName, // Тот самый недостающий аргумент!
        )
