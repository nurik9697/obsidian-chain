...
const (
	Query_Params_FullMethodName      = "/obsidian.notary.Query/Params"
	Query_Document_FullMethodName    = "/obsidian.notary.Query/Document"
	Query_DocumentAll_FullMethodName = "/obsidian.notary.Query/DocumentAll"
)
